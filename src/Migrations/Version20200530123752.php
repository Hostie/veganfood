 ...
 */
final class Version20200530123752 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE meal (id INT AUTO_INCREMENT NOT NULL, id_command_id INT DEFAULT NULL, id_restaurant_id INT NOT NULL, name VARCHAR(255) NOT NULL, photo VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_9EF68E9C966BE84D (id_command_id), INDEX IDX_9EF68E9CFCFA10B (id_restaurant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
