 ...
 */
final class Version20200530094236 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE meal ADD id_command_id INT DEFAULT NULL, ADD id_restaurant_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_9EF68E9CFCFA10B ON meal (id_restaurant_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_9EF68E9CFCFA10B ON meal');
        $this->addSql('ALTER TABLE meal DROP id_command_id, DROP id_restaurant_id');
