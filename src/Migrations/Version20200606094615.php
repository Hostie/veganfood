 ...
 */
final class Version20200606094615 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE command (id INT AUTO_INCREMENT NOT NULL, id_user_id INT NOT NULL, id_restaurant_id INT NOT NULL, price VARCHAR(10) NOT NULL, date DATE NOT NULL, status TINYINT(1) NOT NULL, INDEX IDX_8ECAEAD479F37AE5 (id_user_id), INDEX IDX_8ECAEAD4FCFA10B (id_restaurant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE command ADD CONSTRAINT FK_8ECAEAD4FCFA10B FOREIGN KEY (id_restaurant_id) REFERENCES restaurant (id)');
